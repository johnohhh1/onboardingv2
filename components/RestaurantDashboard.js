      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm font-medium opacity-80 text-gray-900 dark:text-white">{title}</p>
          </div>
          <p className="text-3xl font-bold text-gray-900 dark:text-white">{value}</p>
          {subtitle && <p className="text-sm opacity-70 mt-1 text-gray-700 dark:text-gray-300">{subtitle}</p>}
        </div>
        {trend && (
          <div className="text-right">
            <TrendingUp className="w-6 h-6 opacity-60 ml-auto" />
  ...
  const TeamMemberCard = ({ member }) => {
    return (
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow">
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-200">{member.position} • {member.employeeId}</p>
                <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 mt-1 transition-colors duration-200">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-3 py-1 rounded text-sm font-medium transition-colors"
              >
                View/Edit Progress
              </button>
        ...
        {/* Action Footer */}
        <div className="px-6 py-3 bg-gray-50 dark:bg-gray-700 border-t border-gray-100 dark:border-gray-600 flex justify-between items-center">
          <div className="flex items-center gap-2">
          ...
          <div className="flex gap-2">
            ...
            <button 
              ...
              className="text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100 p-1 transition-colors duration-200"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white transition-colors duration-200">{currentRestaurant.name}</h1>
                <p className="text-gray-600 dark:text-gray-300 transition-colors duration-200">{currentRestaurant.location} • Manager: {currentRestaurant.manager}</p>
              </div>
            </div>
